...
urlpatterns = [ 
    ...
    path("users/contacts/",views.ContactList.as_view(), name='contact-list'),
    path("users/contacts/<int:pk>/",views.ContactDetail.as_view(), name='contact-detail'),
    ...
    path("users/tasks/",views.TaskList.as_view(), name='task-list'),
    path("users/tasks/<int:pk>/",views.TaskDetail.as_view(), name='task-detail'),
]
